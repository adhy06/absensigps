<form action="/karyawan/{{ $karyawan->nik }}/update"  method="POST" id="loadeditform" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nik" name="nik" readonly value="{{ $karyawan->nik }}" class="form-control" placeholder="NIK (Nomor Induk Karyawan)">
            </div>
            ...
            <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ $karyawan->nama_lengkap }}" class="form-control" placeholder="Nama Lengkap">
            </div>
              ...
              <div class="input-icon mb-3">
                ...
                <input type="text" id="no_hp" name="no_hp" value="{{ $karyawan->no_hp }}" class="form-control" placeholder="Nomor Whatsapp">
              </div>
            </div>
                </div>
                <div class="row mt-2">
